...
class Login:
    ...
    def login_menu_display(self):
        ...
        while True:
            ...
            choice = input(generic_statements.get('choice'))
            ...
            match choice:
                case "1":
                    while True:
                        ...
                        (access, access_type) = self.validate_user(user_name, password)
                        if access:
                            print(generic_statements.get('authenticated'))
                            if access_type == 0:
                                # call employee menu display function
                                employee_caller = employee_page.Employee(user_name)
